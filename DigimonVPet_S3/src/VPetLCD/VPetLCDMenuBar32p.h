...
class VPetLCDMenuBar32p{
    ...
    private:
        ...
        uint16_t activeIconColor; //color for an icon that wants attention
        bool* activeFlags; //per-icon active/attention state
    ...
    public:
        ...
        void setIconActive(uint8_t menuItemIndex, bool active);
        ...
        uint16_t getActiveIconColor(){return activeIconColor;};
        void setActiveIconColor(uint16_t _activeIconColor){activeIconColor = _activeIconColor;};
